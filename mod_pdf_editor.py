# -*- coding: utf-8 -*-
"""
Created on Mon Dec 16 15:26:15 2019
...
def pdf_editor_extract_continuous_page( pdfpath="", pdfname="", Fstpg=0, Lstpg=1, pdfname_out="" ):
    ...
    for i in range(len(information)):
        ...
        with open( pdfpath + pdfname_out,'wb') as out:
            ...
            print(pdfname_out + "\t saved successfully. ")
             

def pdf_editor_extract_multi_page( pdfpath="", pdfname="", pagelist=[], pdfname_out="" ):   
...
def pdf_editor_combine_multi_file( pdfpath="", pdfname="", pdfname_out="" ):   
...
if 0:
    ...
    pdf_editor_extract_continuous_page(pdfpath, pdfname, Fstpg, Lstpg)
    
    
    # demo of extracting a set of single pages from a pdf file
    pdfname = "all_marks"               # filenmae - no extension
    pagelist = [2,4,6,8]
    pdf_editor_extract_multi_page( pdfpath, pdfname, pagelist, pdfname_out = "multi_pg")
    ...
    pdflist = [ "a", "aa", "a" ]
    pdf_editor_combine_multi_file(pdfpath, pdflist, pdfname_out = "multi_fl")
